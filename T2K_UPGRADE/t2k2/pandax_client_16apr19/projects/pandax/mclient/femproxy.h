/*******************************************************************************
 ...
 History:
   ...
   October 2018: defined constants MAX_REQ_CREDIT_FRAMES and
   CREDIT_THRESHOLD_FRAMES_FOR_REQ

   December 2018: added member is_arc to FemProxy structure and added is_arc
   to FemProxy_Open() argument list
...
#define CREDIT_THRESHOLD_BYTES_FOR_REQ   8*1024
#define MAX_REQ_CREDIT_FRAMES            8
#define CREDIT_THRESHOLD_FRAMES_FOR_REQ  1
